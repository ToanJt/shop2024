        ...
        <div class="w-pc mx-auto grid grid-cols-3 gap-20">
            <div class="text-left col-span-1">
                <div class=" flex flex-col ">
                    ...
                    <h3 class="tracking-[12px] font-black text-xl">Fashion</h3>
                </div>
                <p class="mt-4 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit quae debitis
                    nobis,
                    nesciunt a in corrupti
                    expedita perferendis, mollitia provie.</p>
                <div class="flex gap-2 mt-4">
                    <div class="px-4 py-1 flex items-center gap-2 border-[1px] rounded-sm">
                        <svg class="h-6 MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1mbx69x" focusable="false"
                            aria-hidden="true" viewBox="0 0 24 24" data-testid="PlayStoreIcon" fill="currentColor">
                            <g>
                                <path
                    ...
                    <div class="px-4 py-1 flex items-center gap-2 border-[1px] rounded-sm">
                        <svg class="h-6 MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1mbx69x" focusable="false"
                            aria-hidden="true" viewBox="0 0 24 24" data-testid="AppleStoreIcon" fill="currentColor">
                            <g>
                                <path
            ...
            <div class="text-left">
                <h3 class="font-semibold text-lg mb-4">Liên Hệ Với Chúng Tôi</h3>
                <div>
                    <p class="mb-2">147 Bà Triệu, Xuân Phú, Thành phố Huế, Thừa Thiên Huế, Việt Nam</p>
                    ...
                    <div class="flex gap-4 mt-8">
                        ...
                        <Icon icon="ri:google-fill" width="2em" height="2em" style="color: white" />
                    </div>
                </div>
            </div>
        </div>
