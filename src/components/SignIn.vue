    ...
    <div class="grid md:grid-cols-2 grid-cols-1 container mx-auto">
        ...
        <div class="w-full bg-gray-100 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Chào mừng bạn quay trở lại</h1>
                <div class="mt-4 flex flex-col lg:flex-row items-center justify-between">
                    <div class="w-full lg:w-1/2 mb-2 lg:mb-0">
                        <button type="button"
                            ...
                            </svg> Đăng nhập với Google </button>
                    </div>
                    <div class="w-full lg:w-1/2 ml-0 lg:ml-2">
                        <button type="button"
                            ...
                            </svg> Đăng nhập với Github </button>
                    </div>
                </div>
                ...
                <form @submit.prevent="" method="POST" class="space-y-4 text-left">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Nhập tên người dùng hoặc email..." id="username" name="username"
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>Bạn chưa có tài khoản?
                        <router-link :to="{ path: '/signup' }">Đăng ký</router-link>
                    </p>
                </div>
            </div>
        </div>
