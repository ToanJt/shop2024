    ...
    <div class="grid grid-cols-2 w-pc mx-auto">
        ...
        <div class="w-full bg-gray-100 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                <h1 class="text-3xl font-semibold mb-6 text-black text-center">Đăng ký</h1>
                <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Tham gia cửa hàng của chúng tôi với
                    quyền truy cập mọi lúc và miễn phí</h1>
                ...
                <form @submit.prevent="" method="POST" class="space-y-4 text-left">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Nhập tên người dùng..." id="username" name="username"
                            class="mt-1 bg-white p-2 w-full border rounded-md focus:border-gray-200 outline-none transition-colors duration-300">
                    </div>
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="text" placeholder="Nhập email của bạn..." id="email" name="email"
                            class="mt-1 p-2 text- bg-white  w-full border rounded-md focus:border-gray-200 outline-none transition-colors duration-300">
                    </div>
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">Mật khẩu</label>
                        <input placeholder="******" type="password" id="password" name="password"
                            class="mt-1 p-2 bg-white  w-full border rounded-md focus:border-gray-200 outline-none transition-colors duration-300">
                    </div>
                    <div>
                        <button type="submit"
                            class="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 outline-none  focus:ring-gray-900 transition-colors duration-300">Đăng
                            ký</button>
                    </div>
                </form>
                <div class="mt-4 text-sm text-gray-600 text-center">
